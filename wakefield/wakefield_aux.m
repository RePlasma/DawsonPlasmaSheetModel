function [Edump1,Edump2,Edump3,Edump4,xlst,vend,xend] = wakefield_aux(v,vth,nparts,xlstdim)
...
Edump1 = Elst(1,:);
Edump2 = Elst(round(numel(tdump)/3),:);
Edump3 = Elst(round(2*numel(tdump)/3),:);
Edump4 = Elst(end,:);
vend = vit(end,:);
xend = xit(end,:);